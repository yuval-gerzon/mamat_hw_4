...
grep -E "https:\/\/www.ynetnews.com\/article\/[A-Z,a-z,0-9]{9}[^A-Z,a-z,0-9]" 3082 -o \
|sort -u > temp_links.txt

grep -E "https:\/\/www.ynetnews.com\/article\/[A-Z,a-z,0-9]{9}" temp_links.txt -o \
|sort -u > links.txt
